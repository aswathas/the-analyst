...
export const BouncingBalls: FC<BouncingBallsProps> = ({
  ...
  }, [numBalls, backgroundColor, colors, opacity, minRadius, maxRadius, speed, bounceDamping, gravity, friction, interactionRadius, interactionScale, interactive, followMouse, trailAlpha])
